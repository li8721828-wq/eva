...
export const BUILT_IN_AGENTS: Omit<AgentConfig, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  },
  {
    ...
    model: 'gpt-4o',
    providerId: 'openai',
    tools: ['inspect_runtime', 'diagnose_runtime', 'create_runtime_proposal', 'read_file', 'list_directory', 'search_files', 'search_code', 'search_by_regex', 'project_search', 'project_index_status'],
    maxIterations: 15,
    temperature: 0.3,
    isBuiltIn: true,
  },
  {
    ...
    model: 'gpt-4o',
    providerId: 'openai',
    tools: ['inspect_runtime', 'diagnose_runtime', 'create_runtime_proposal', 'read_file', 'list_directory', 'search_files', 'search_code', 'search_by_regex', 'project_search', 'project_index_status', 'web_search', 'read_web_page'],
    maxIterations: 15,
    temperature: 0.5,
    isBuiltIn: true,
  },
