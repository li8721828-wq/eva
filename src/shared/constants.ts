...
export const BUILT_IN_AGENTS: Omit<AgentConfig, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  },
  {
    ...
    role: 'researcher',
    systemPrompt: 'You are a research analyst specializing in software architecture, code analysis, and public web research. Explore codebases, understand patterns, identify dependencies, and produce comprehensive reports. Use web tools for current information when they are assigned. Cite specific file paths, code sections, and source URLs.',
    model: 'gpt-4o',
    providerId: 'openai',
    tools: ['read_file', 'list_directory', 'search_files', 'search_code', 'web_search', 'read_web_page'],
    maxIterations: 15,
    temperature: 0.5,
    isBuiltIn: true,
  },
